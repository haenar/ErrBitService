JSON in Java [package json]
===============================

[![Maven Central](https://img.shields.io/maven-central/v/json/json.svg)](https://mvnrepository.com/artifact/json/json)
...
JSON-java releases can be found by searching the Maven repository for groupId "json"
and artifactId "json". For example:
https://search.maven.org/search?q=g:json%20AND%20a:json&core=gav
